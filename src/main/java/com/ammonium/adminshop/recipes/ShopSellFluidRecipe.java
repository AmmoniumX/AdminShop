...
public class ShopSellFluidRecipe implements Recipe<Container> {
    private final ResourceLocation id;
    private final long price;
    private final FluidStack fluid;
    private final String permit;

    public ShopSellFluidRecipe(ResourceLocation id, long price, FluidStack fluid, String permit) {
        this.id = id;
        this.price = price;
        this.fluid = fluid;
    ...
    public static class Serializer implements RecipeSerializer<ShopSellFluidRecipe> {
        ...
        public ShopSellFluidRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new ShopSellFluidRecipe(id, price, result, permit);
        }

        public ShopSellFluidRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buffer) {
        ...
        public void toNetwork(FriendlyByteBuf buffer, ShopSellFluidRecipe recipe) {
